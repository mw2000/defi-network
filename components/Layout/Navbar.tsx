            ...
            <div className="flex justify-between items-center px-0 md:px-4">
                <span role="link" className="cursor-pointer">
                    <Link href="/" aria-role="home" >
                        <a>
                            <Image src="/logo.svg" alt="defi network llc logo" width={202} height={48} />
                        </a>
                    </Link>
                </span>
                ...
                <div className={`transition-opacity-top duration-500 ease-out pb-12 md:pb-0 flex fixed left-0 right-0 top-0 -z-1 pt-24 md:pt-0 bg-white gap-4 md:gap-0 
                md:flex flex-col md:flex-row md:relative flex-1 justify-center items-center font-medium xl:px-20 md:mx-12 ` +
                    ...
                    <div className="mt-auto block cursor-pointer md:hidden border-solid border-2 w-4/5 text-center  py-2 text-defi-blue transition duration-500 ease-in-out hover:bg-defi-blue hover:text-white border-defi-blue  font-bold">
                        <Link href="/#contact" >
                            <a className="hover:text-white" onClick={closeNavlinks}>
                                Get in touch
                        </a>
                        </Link>
                    </div>
