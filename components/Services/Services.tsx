...
const Services = () => {
    ...
    return (
        <div id="services" className="mt-32 lg:max-w-4xl xl:max-w-5xl xl:pl-8 2xl:max-w-7xl lg:mx-auto ">
            <h2 className="text-lg">Services</h2>
            <p className="text-5xl font-bold my-5">We build modern <br className="hidden lg:inline-block" /> experiences</p>
